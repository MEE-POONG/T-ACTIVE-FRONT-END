...
export default function Home() {
  ...
  return (
    <>
      <NextSeo
        title="T-Active-Stevia"
        description="When I was 10, everyday after school, I’d go straight to YouTube and watch Victoria Secret models working out."
        canonical="https://t-active-stevia.com/"
        openGraph={{
          url: 'https://t-active-stevia.com/',
          title: 'When I was 10, everyday after school, I’d go straight to YouTube and watch Victoria Secret models working out.',
          description: 'When I was 10, everyday after school, I’d go straight to YouTube and watch Victoria Secret models working out.',
          images: [
            {
              url: 'https://t-active-stevia.com/images/logo.png',
              width: 800,
              height: 600,
              alt: 'T-Active-Stevia Image Alt',
              type: 'image/jpeg',
            },
            {
              url: 'https://t-active-stevia.com/images/logo.png',
              width: 900,
              height: 800,
              alt: 'T-Active-Stevia Image Alt Second',
              type: 'image/jpeg',
            },
            { url: 'https://t-active-stevia.com/images/logo.png' },
            { url: 'https://t-active-stevia.com/images/logo.png' },
        ...
        twitter={{
          handle: 'T-Active-Stevia',
          site: 'When I was 10, everyday after school, I’d go straight to YouTube and watch Victoria Secret models working out.',
          cardType: 'https://t-active-stevia.com/images/logo.png',
        }}
      />
