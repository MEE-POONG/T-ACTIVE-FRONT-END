...
export default function Navbar() {
  ...
  const [navbar02, setnavbar02] = useState("absolute bg-black  z-50  right-1 top-4 rounded-3xl font-font01 text-base px-5 py-3  text-yellow-500  flex-col items-center  order-2  w-full hidden md:flex md:flex-row md:w-auto md:order-none")
  ...
  const listenScrollEvent = () => {
    ...
    window.scrollY > 300 ? setnavbar02("fixed z-50 right-0 bottom-16") : setnavbar02(navbar02);
...
<nav className="bg-gray-900 px-2 sm:px-4 py-2.5 fixed w-full z-40 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
